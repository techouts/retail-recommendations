# import json
# from ..adapters.meili.searcher import search_es
...
#     def fetch_all(self, size: int = 20):
#         try:
#             return search_es(
...
#     def fetch_by_l3(self, l3_list: List[str], size: int = 100):
#         if not l3_list:
...
#     def fetch_by_skuid(self, skuid_list: List[str]):
#         if not skuid_list:
